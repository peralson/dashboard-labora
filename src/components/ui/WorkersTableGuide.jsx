...
const WorkersTableGuide = ({
  ...
  return (
  <Flex alignItems={"center"} justifyContent={"space-between"} pl={4} mt={2} mb={1}> 
    <Flex flex={2} alignItems={"center"} py={3}>
      ...
      />
      <Text fontWeight={"medium"} fontSize={14} ml={2} onClick={handleGlobalCheck} cursor={"pointer"}>
        {isChecked || isIndeterminate ? "Anular selección" : "Seleccionar todos"}
      </Text>
    </Flex>
