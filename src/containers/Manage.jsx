		...
		>
			...
			>
				<Main>
					<TopMain borderBottomWidth={0} pb={0}>
						...
						<Flex w={"100%"} mt={4}>
							<CustomTab
								...
								onClick={() => setSelectedTab("Proyectos pasados")}
							>
								Proyectos pasados
							</CustomTab>
							<CustomTab
							...
							<CustomTab
								selectedTab={selectedTab}
								onClick={() => setSelectedTab("Nóminas")}
							>
								Nóminas
							</CustomTab>
							<CustomTab
								selectedTab={selectedTab}
								onClick={() => setSelectedTab("Plantillas")}
								mr={0}
							>
								Plantillas
							</CustomTab>
					...
					{selectedTab === "Proyectos pasados" && (
						<ManageProjects search={search} />
					)}
